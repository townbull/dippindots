...
# Set highlight color to bluish grey
...
# Hide system sounds (trash emptying, screenshot)
...
# Disable MacBook keyboard illumination in low light
...
# Hide a bunch of apps I wish I could remove.
for app in Stickies Game\ Center iBooks DVD\ Player Dashboard Chess Contacts Time\ Machine Reminders Photo\ Booth Mission\ Control FaceTime Messages Launchpad Notes iTunes Maps Dictionary Calculator Automator App\ Store Image\ Capture
do
    sudo chflags hidden "/Applications/$app.app/"
done

# Hide directories I never use.
for dir in Movies Music Pictures Public Documents env
do
    sudo chflags hidden "~/$dir"
done
...
###############################################################################
# iCal, TextEdit, and Disk Utility												                    #
###############################################################################
...
for app in "Activity Monitor" "Address Book" "Calendar" "Contacts" "cfprefsd" "Dashboard" "Dock" "Finder" \
